                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input id="name" placeholder="First name" type="text" class="form-control" name="name" value="{{ old('name') }}" required autofocus>
                            ...
                            <div class="col-md-3">
                                <input id="name" placeholder="Last name" type="text" class="form-control" name="">
                            </div>
                        </div>
